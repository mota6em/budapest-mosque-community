          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-primary-foreground/80 mb-6 leading-relaxed">
                A welcoming digital space for Muslims to connect, learn, and
                grow together in faith. We provide prayer times, Islamic
                knowledge, and community resources to support your spiritual
                journey.
              </p>
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-primary-foreground/20 p-3 rounded-full hover:bg-primary-foreground/30 transition-colors duration-200"
                >
